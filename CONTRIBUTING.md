...
# Contribute to Ory kratos-selfservice-ui-react-nextjs<!-- omit in toc -->
...
- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/kratos-selfservice-ui-react-nextjs/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory kratos-selfservice-ui-react-nextjs?](#communication)
...
- I want to talk to other Ory kratos-selfservice-ui-react-nextjs users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  kratos-selfservice-ui-react-nextjs. Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/kratos-selfservice-ui-react-nextjs)
...
[list of good first issues](https://github.com/ory/kratos-selfservice-ui-react-nextjs/labels/good%20first%20issue).
...
- **Give us a star.** It may not seem like much, but it really makes a
  ...
  kratos-selfservice-ui-react-nextjs. Github stars help the project gain
...
- **Help with open issues.** We have a lot of open issues for Ory
  kratos-selfservice-ui-react-nextjs and some of them may lack necessary
  information, some are duplicates of older issues. You can help out by guiding
  people through the process of filling out the issue template, asking for
  clarifying information or pointing them to existing issues that match their
...
1. Open a
   [Discussion](https://github.com/ory/kratos-selfservice-ui-react-nextjs/discussions/new/choose)
   or
   [Issue](https://github.com/ory/kratos-selfservice-ui-react-nextjs/issues/new/choose)
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/kratos-selfservice-ui-react-nextjs/blob/master/.github/workflows/conventional_commits.yml)
...
[Contributor License Agreement](https://cla-assistant.io/ory/kratos-selfservice-ui-react-nextjs).
...
maintain the quality and reliability of Ory kratos-selfservice-ui-react-nextjs,
...
git clone git@github.com:ory/ory/kratos-selfservice-ui-react-nextjs.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/kratos-selfservice-ui-react-nextjs.git
